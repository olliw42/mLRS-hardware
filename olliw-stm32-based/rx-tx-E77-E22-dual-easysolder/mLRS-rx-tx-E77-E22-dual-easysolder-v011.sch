...
<sheet>
<plain>
<text x="180.34" y="-38.1" size="2.54" layer="91">9. Mai 2024</text>
...
- C5, C6, E22 are needed only for diversity
- If used as tx module, then in the software
  Tx/Rx must be swapped. That way S becomes
  the IN (input) signal.
</text>
<rectangle x1="134.62" y1="106.68" x2="208.28" y2="124.46" layer="201"/>
